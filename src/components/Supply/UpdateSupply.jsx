    ...
    return (
        <Form className='form-add' style={{ marginTop: "30px", marginBottom: "30px" }} >
            <Form.Group className="mb-3" >
                ...
                }} value={supply.name} type="text" placeholder="Tên nhà cung cấp ..." />
            ...
            <Form.Group className="mb-3" >
                ...
                }} value={supply.phone} type="number" placeholder="Số điện thoại ..." />
            ...
            <Form.Group className="mb-3" >
                ...
                }} value={supply.street} type="text" placeholder="Địa chỉ ..." />
